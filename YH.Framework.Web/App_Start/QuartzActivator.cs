...
using YH.Framework.Web.Areas.CmsAdmin.Quartz;
using Unity.Lifetime;
using YH.Framework.Core.Infrastructure;
using Quartz;
using Quartz.Logging;
using YH.Framework.Core.Configuration;
using Unity;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(YH.Framework.Web.App_Start.QuartzActivator), "Start", Order = 1)]
[assembly: WebActivatorEx.ApplicationShutdownMethod(typeof(YH.Framework.Web.App_Start.QuartzActivator), "Shutdown")]
