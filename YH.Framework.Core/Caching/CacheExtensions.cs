...
namespace YH.Framework.Core.Caching
{
    public static class CacheExtensions
    {
        ...
        {
            return Get(cacheManager, key, TimeSpan.FromMinutes(1), acquire);
        }
        ...
        public static void Remove(this ICacheManager cacheManager, string pattern, IEnumerable<string> keys)
        {
