...
layui.define("jquery", function (e) {
    ...
    D.prototype.config = {
        ...
        format: "hex",
        predefine: !1,
        colors: ["#489DFC", "#489DFC", "#1E9FFF", "#FF5722", "#FFB800", "#01AAED", "#999", "#c00", "#ff8c00", "#ffd700", "#90ee90", "#00ced1", "#1e90ff", "#c71585", "rgb(0, 186, 189)", "rgb(255, 120, 0)", "rgb(250, 212, 0)", "#393D49", "rgba(0,0,0,.5)", "rgba(255, 69, 0, 0.68)", "rgba(144, 240, 144, 0.5)", "rgba(31, 147, 255, 0.73)"]
...
layui.define("form", function (e) {
    ...
    var i = layui.$,
        ...
        y = "layui-tree-pack",
        v = "layui-tree-spread",
        C = "layui-tree-setLineShort",
        m = "layui-tree-showLine",
        k = "layui-tree-lineExtend",
        g = function (e) {
            var a = this;
    ...
    g.prototype.config = {
        ...
        var n = this,
            ...
            C = l.find("." + c),
            m = l.find("." + p),
            k = r.onlyIconControl ? C : t,
            g = "";
        k.on("click", function (i) {
            var a = e.children("." + y),
                n = k.children(".layui-icon")[0] ? k.children(".layui-icon") : k.find(".layui-tree-icon").children(".layui-icon");
            if (a[0]) {
                if (e.hasClass(v)) e.removeClass(v), a.slideUp(200), n.removeClass(h).addClass(o);
                else if (e.addClass(v), a.slideDown(200), n.addClass(h).removeClass(o), r.accordion) {
                    var l = e.siblings("." + s);
        ...
        l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (l) {
            ...
            if ("add" == f) {
                ...
                var b = r.operate && r.operate(x),
                    w = {};
                if (w.title = r.text.defaultNodeName, w.id = b, n.tree(e.children("." + y), [w]), r.showLine)
                    if (g[0]) g.hasClass(k) || g.addClass(k), e.find("." + y).each(function () {
                        i(this).children("." + s).last().addClass(C)
                    }), g.children("." + s).last().prev().hasClass(C) ? g.children("." + s).last().prev().removeClass(C) : g.children("." + s).last().removeClass(C), !e.parent("." + y)[0] && e.next()[0] && g.children("." + s).last().removeClass(C);
                    else {
                        var T = e.siblings("." + s),
                            L = 1,
                            N = e.parent("." + y);
        ...
        e.elem.on("dragstart", "." + u, function () {
            ...
            var S = function (n) {
                ...
                if (1 == H) a.showLine ? (n.find("." + c).removeClass("layui-tree-icon"), n.find("." + c).children(".layui-icon").removeClass(h).addClass("layui-icon-file"), q.addClass(k), q.children("." + s).children("." + y).each(function () {
                    i(this).children("." + s).last().addClass(C)
                })) : n.find(".layui-tree-iconArrow").addClass(t), n.children("." + y).remove(), n.removeClass(v);
                else {
                    if (a.showLine) {
                        var r = 1;
        ...
        layui.each(n, function (e, a) {
            ...
            }), 0 == l.find(".layui-tree-searchShow").length && e.elem.append(e.elemNone), a.onsearch && a.onsearch({
                elem: d
            })
