...
{
    ///<summary>
    /// Options for configuring the output of <see cref = "YH.Framework.Web.Core.Paging.PagerExtensions" />.
    ///</summary>
    public class PagerOptions
    {
        ...
        public PagerOptions()
        {
            Display = PagerBehavior.IfNeeded;
            ...
            ContainerDivClasses = new[] { "pagination-container text-center" };
            UlElementClasses = new[] { "pagination" };
            LiElementClasses = Enumerable.Empty<string>();
            PageClasses = Enumerable.Empty<string>();
            UlElementattributes = null;
            ActiveLiElementClass = "active";
            EllipsesElementClass = "ellipses";
